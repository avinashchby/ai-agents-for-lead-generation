...
const FALLBACK_VENDORS: VendorBase[] = [
  {
    "name": "Apollo.io",
    "vendor": "Apollo.io",
    "description": "AI-powered prospecting with 270M+ verified B2B contacts",
  ...
  },
  {
    "name": "ZoomInfo",
    "vendor": "ZoomInfo",
    "description": "B2B intelligence platform with AI-driven lead scoring",
    "pricing_model": "paid",
  ...
  },
  {
    "name": "Seamless.AI",
    "vendor": "Seamless.AI",
    "description": "Real-time AI contact data for lead generation",
    "pricing_model": "freemium",
  ...
  },
  {
    "name": "LeadIQ",
    "vendor": "LeadIQ",
    "description": "AI prospecting tool for SDRs with CRM enrichment",
    "pricing_model": "freemium",
  ...
  },
  {
    "name": "Clay",
    "vendor": "Clay",
    "description": "Multi-source data aggregation for AI-powered lead enrichment",
    "pricing_model": "freemium",
  ...
  },
  {
    "name": "Instantly",
    "vendor": "Instantly",
    "description": "AI cold email platform with automated lead outreach",
    "pricing_model": "paid",
...
try {
  ...
  log.info('Starting actor', { mode, maxResults, slug: 'ai-agents-for-lead-generation' });
